          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="mt-1 flex gap-1 text-sm font-medium text-gray-700">
                  <span>{t("address")}:</span>
            ...
            <div
              className={cn(
                "border-t-none -mt-4 space-y-2 border-x border-gray-300 p-2",
                invoice.payments?.filter(
                  (p) => p.status === PaymentReconciliationStatus.active,
                ).length === 0 && "rounded-b-md border-b",
              )}
            >
              <div className="mb-4 flex flex-col items-end space-y-2 text-sm font-normal text-gray-950">
                {/* Base Amount */}
                ...
                {invoice.total_price_components
                  ...
                  .map((component, index) => (
                    <div
                      key={`surcharge-${index}`}
                      className="flex w-64 justify-between text-sm text-gray-500"
                    >
                      <span>
                ...
                <div className="w-full border-t-2 border-dashed border-gray-200 p-1" />
            ...
            {invoice.payments?.filter(
              ...
              <>
                <div className="-mt-4 space-y-2 rounded-b-md border-x border-t border-b border-gray-300">
                  <Table>
                    <TableHeader>
                      <TableRow className="border-b border-gray-200">
                        <TableHead className={tableHeadClass}>#</TableHead>
                ...
                <div className="mb-4 flex flex-col items-end space-y-2 text-sm font-normal text-gray-950">
                  ...
                  <div className="w-full border-b-2 border-dashed border-gray-200 p-1" />
                </div>
              </>
            )}
